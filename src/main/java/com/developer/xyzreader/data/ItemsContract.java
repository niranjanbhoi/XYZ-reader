package com.developer.xyzreader.data;

import android.net.Uri;

public class ItemsContract {
    public static final String CONTENT_AUTHORITY = "com.developer.xyzreader";
    public static final Uri BASE_URI = Uri.parse("content://com.developer.xyzreader");
    ...
    public static class Items implements ItemsColumns {
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.com.developer.xyzreader.items";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.com.developer.xyzreader.items";
